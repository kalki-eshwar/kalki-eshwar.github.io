...
const mdxComponents = {
  ...
  h4: (props: any) => <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4" {...props} />,
  ...
  blockquote: (props: any) => (
    <blockquote className="border-l-4 border-red-600 pl-4 italic text-gray-600 my-6" {...props} />
  ),
  code: (props: any) => (
  ...
  td: (props: any) => <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900" {...props} />,
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="mb-4 sm:mb-0">
                <p className="text-gray-600">
                  Written by <span className="font-medium text-gray-900">{article.author}</span>
                </p>
          ...
          <div className="container max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedArticles.map((relatedArticle) => (
                <article key={relatedArticle.slug} className={`border rounded-lg p-6 transition-colors duration-200 ${relatedArticle.featured ? 'bg-red-50/30 border-red-300 hover:border-red-400' : 'bg-white border-gray-200 hover:border-gray-300'}`}>
                  ...
                  <div className="space-y-3">
                    <div className={`flex items-center text-sm ${relatedArticle.featured ? 'text-red-600' : 'text-gray-500'}`}>
                    ...
                    <h3 className={`text-lg font-medium line-clamp-2 ${relatedArticle.featured ? 'text-red-900' : 'text-gray-900'}`}>
                      {relatedArticle.title}
                    </h3>
                    
                    <p className={`text-sm line-clamp-3 ${relatedArticle.featured ? 'text-red-700' : 'text-gray-600'}`}>
