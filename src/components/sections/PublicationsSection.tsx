      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {publications.slice(0, 3).map((publication, index) => (
            <div key={index} className={`border rounded-lg p-6 hover:border-gray-300 transition-all duration-200 hover:shadow-sm ${publication.featured ? 'border-red-200 bg-red-50/30' : 'border-gray-200'}`}>
